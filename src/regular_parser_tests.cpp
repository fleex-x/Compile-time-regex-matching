...
namespace all_instantiations {
	derivative_v <'a', alt_regex<empty_regex, epsilon_regex>> inst1_;
	derivative_v <'a', alt_regex<empty_regex, empty_regex>> inst2_;
	derivative_v <'a', alt_regex<epsilon_regex, empty_regex>> inst3_;
	derivative_v <'a', alt_regex<empty_regex, star_regex<epsilon_regex>>> inst4_;
	derivative_v <'a', alt_regex<star_regex<epsilon_regex>, empty_regex>> inst5_;
	derivative_v <'a', alt_regex<epsilon_regex, star_regex<epsilon_regex>>> inst6_;
	derivative_v <'a', alt_regex<star_regex<epsilon_regex>, epsilon_regex>> inst7_;
	derivative_v <'a', alt_regex<epsilon_regex, epsilon_regex>> inst8_;
}

namespace all_instantiations {
	derivative_v <'a', concat_regex<empty_regex, epsilon_regex>> inst1;
	derivative_v <'a', concat_regex<empty_regex, empty_regex>> inst2;
	derivative_v <'a', concat_regex<epsilon_regex, empty_regex>> inst3;
	derivative_v <'a', concat_regex<empty_regex, star_regex<epsilon_regex>>> inst4;
	derivative_v <'a', concat_regex<star_regex<epsilon_regex>, empty_regex>> inst5;
	derivative_v <'a', concat_regex<epsilon_regex, star_regex<epsilon_regex>>> inst6;
	derivative_v <'a', concat_regex<star_regex<epsilon_regex>, epsilon_regex>> inst7;
	derivative_v <'a', concat_regex<epsilon_regex, epsilon_regex>> inst8;
